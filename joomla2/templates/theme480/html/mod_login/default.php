...
<form action="<?php echo JRoute::_( 'index.php', true, $params->get('usesecure')); ?>" method="post" name="login" class="form-login">
    ...
    <div class="clearfix">
        ...
        <div class="username form-height">
            <input id="modlgn_username" type="text" name="username" class="inputbox" alt="username"  size="18" onclick="this.value=''" />
        </div>
        <label for="modlgn_passwd"><?php echo JText::_('Password:') ?></label>
        <div class="password  form-height">
            <input id="modlgn_passwd" type="password" name="passwd" class="inputbox" size="18"  alt="password" onclick="this.value=''" />
            <br />
        </div>
        <input type="submit" name="Submit" class="button-login png" value="<?php echo JText::_('BUTTON_LOGIN'); ?>" />
         <div id="inputs">
