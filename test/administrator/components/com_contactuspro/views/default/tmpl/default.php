<style type="text/css">
.icon-48-mytoobar_title{
	background-image: url(../images/letter_48.png);
}
</style>
<?php
...
JToolBarHelper::title('Contact Us Pro');
JToolBarHelper::preferences('com_contactuspro','500','800');
?>
<p>Use the Parameters icon in the upper right to make global component changes, or create a new menu item and use the Component Parameters tab to make changes to individual pages.</p>